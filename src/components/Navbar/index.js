...
export default function NavBar({ user, setUser }) {
    ...
    const exampleStudentId = "4qK339SZdVGV0thmvoJJ";
        ...
        <>
            <nav className="navbar">
                <ul>
                    ...
                    <li>
                        <Link to="/view-tutors">Tutor List</Link>
                    </li>
                    <li>
                        <Link to="/view-students">Student List</Link>
                    </li>
                    <li>
                        <Link to={`/matching/${exampleStudentId}`}>
                            Matching
                        </Link>
                    </li>
